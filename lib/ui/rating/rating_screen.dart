...
import 'package:ebookadminpanel/ui/rating/subwidget/rating_web_widget.dart';
...
class RatingScreen extends StatefulWidget {
  ...
  RatingScreen({required this.function});
    ...
    return SafeArea(
      child: CommonPage(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(context, 'Rating', 75, getFontColor(context),
