...
import 'package:ebookadminpanel/ui/kegiatan_literasi/subwidget/kegiatan_literasi_mobile_widget.dart';
import 'package:ebookadminpanel/ui/kegiatan_literasi/subwidget/kegiatan_literasi_web_widget.dart';
...
class KegiatanLiterasiScreen extends StatefulWidget {
  final Function function;

  KegiatanLiterasiScreen({required this.function});

  @override
  State<KegiatanLiterasiScreen> createState() => _KegiatanLiterasiScreenState();
}

class _KegiatanLiterasiScreenState extends State<KegiatanLiterasiScreen> {
    ...
    return SafeArea(
      child: CommonPage(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(
                context, 'Kegiatan Literasi', 75, getFontColor(context),
  ...
  updateStatus(
      BuildContext context, KegiatanLiterasiModel kegiatanLiterasiModel) {
    PrefData.checkAccess(
        context: context,
        function: () {
          getCommonDialog(
              context: context,
              title: kegiatanLiterasiModel.isActive!
  ...
  _showPopupMenu(BuildContext context, var detail,
      KegiatanLiterasiModel kegiatanLiterasiModel) async {
      ...
      items: [
        PopupMenuItem<String>(
            ...
            onTap: () {
              ...
              homeController.setKegiatanLiterasiModel(kegiatanLiterasiModel);
            },
            value: 'Edit'),
        PopupMenuItem<String>(
            child: Container(
            ...
            onTap: () {
              PrefData.checkAccess(
                  ...
                  function: () {
                    getCommonDialog(
                        context: context,
                        title: 'Apakah ingin menghapus kegiatan literasi ini?',
                        function: () async {
                          await FirebaseData.deleteData(
                              tableName: KeyTable.kegiatanLiterasi,
                              doc: kegiatanLiterasiModel.id!,
                              function: () {
                                FirebaseData.refreshKegiatanLiterasiData();
                              });
                          ...
                          await FirebaseData.deleteBatch(
                            ...
                            kegiatanLiterasiModel.id!,
                            KeyTable.kegiatanLiterasi,
