...
import 'package:ebookadminpanel/ui/donation_book/subwidget/mobile_widget.dart';
import 'package:ebookadminpanel/ui/donation_book/subwidget/web_widget.dart';
...
class DonasiBookScreen extends StatefulWidget {
  final Function function;

  DonasiBookScreen({required this.function});

  @override
  State<DonasiBookScreen> createState() => _DonasiBookScreenState();
}

class _DonasiBookScreenState extends State<DonasiBookScreen> {
  @override
  void initState() {
    super.initState();
    ...
    return SafeArea(
      child: CommonPage(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(context, 'Donasi Buku', 75, getFontColor(context),
  ...
  updateStatus(BuildContext context, DonationBookModel storyModel) {
  ...
  _showPopupMenu(
      BuildContext context, var detail, DonationBookModel storyModel) async {
