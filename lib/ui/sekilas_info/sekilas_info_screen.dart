...
class SekilasInfoScreen extends StatefulWidget {
  final Function function;

  SekilasInfoScreen({required this.function});

  @override
  State<SekilasInfoScreen> createState() => _SekilasInfoScreenState();
}

class _SekilasInfoScreenState extends State<SekilasInfoScreen> {
    ...
    return SafeArea(
      child: CommonPage(
        ...
        child: Column(
          ...
          children: [
            getTextWidget(context, 'Sekilas Info', 75, getFontColor(context),
                          ...
                          children: [
                            ...
                            getButtonWidget(
                              ...
                              () {
                                ...
                                if (homeController.sekilasInfoModel != null) {
                                  homeController.sekilasInfoModel = null;
                                }
  ...
  updateStatus(BuildContext context, SekilasInfoModel sekilasInfoModel) {
    PrefData.checkAccess(
        context: context,
        function: () {
          getCommonDialog(
              context: context,
              title: sekilasInfoModel.isActive!
                  ? 'Apakah ingin menonaktifkan sekilas info ini?'
                  : 'Apakah ingin mengaktifkan sekilas info ini?',
              function: () {
                print("dataupdated");
                FirebaseData.updateData(
                    context: context,
                    map: {
                      'is_active': sekilasInfoModel.isActive! ? false : true
                    },
              ...
              subTitle: 'Sekilas Info');
        });
  }

  _showPopupMenu(BuildContext context, var detail,
      SekilasInfoModel sekilasInfoModel) async {
      ...
      items: [
        PopupMenuItem<String>(
            ...
            onTap: () {
              ...
              // sekilasInfoController.isStatus = true;

              homeController.setSekilasInfoModel(sekilasInfoModel);
            },
            value: 'Edit'),
        PopupMenuItem<String>(
            child: Container(
            ...
            onTap: () {
              PrefData.checkAccess(
                  ...
                  function: () {
                    getCommonDialog(
                        context: context,
                        title: 'Apakah ingin menghapus sekilas info ini?',
                        function: () async {
                          await FirebaseData.deleteData(
                              tableName: KeyTable.sekilasInfo,
                              doc: sekilasInfoModel.id!,
                              function: () {
                                FirebaseData.refreshSekilasInfoData();
                              });
