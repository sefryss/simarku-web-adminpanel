                      ...
                      if (snapshot.connectionState == ConnectionState.active) {
                        if (snapshot.data != null && snapshot.data!.size > 0) {
                          ...
                          return GetBuilder<SettingController>(
                            ...
                            builder: (controller) {
                              return (Responsive.isMobile(context))?ListView(
                                children: [
                                  getVerticalSpace(
                                  ...
                                  itemSubTitle('Terms And Conditions', context),
                                  getVerticalSpace(context, 10), getTextFiledWidget(
                                      context, "https://google.com", controller.termLinkController),
                                  getVerticalSpace(context, 22),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: QuillToolbar.simple(
                                            configurations: QuillSimpleToolbarConfigurations(controller: controller.aboutController)
